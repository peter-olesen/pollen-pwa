...
export const getUserLocation = async () => {
  ...
  const fetchUserLocationName = async (latitude, longitude) => {
    ...
    const populateSelect = (existingLocationNames) => {
      ...
      optionElm.value = `${locationName},${latitude},${longitude}`; // Combine location name, latitude, and longitude
  ...
  selectElm.addEventListener("change", async (event) => {
    ...
    // Extract latitude and longitude from selectedLocation format (modify as needed)
